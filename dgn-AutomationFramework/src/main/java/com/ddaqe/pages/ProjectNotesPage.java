...
public class ProjectNotesPage extends ProjectCommonContainerPage {
	...
	@FindBy(how = How.ID, using = "ctl00_contentPlaceHolderHeader_dvReportContent")
	private WebElement projectOverviewSection;

	@FindBy(how = How.CLASS_NAME, using = "notesContentContainer")
	private WebElement notesGrid;

	@FindBy(how = How.XPATH, using = "//div[@class='breadcrumb-container clearfix zeromMarginbottom']/span[last()]")
	private WebElement lastBreadCrumb;

	@FindBy(how = How.CLASS_NAME, using = "importantProjectUpdates")
	private WebElement impProjectUpdatesSection;
	...
	public ProjectNotesPage(WebDriver driver) {
		super(driver);
		this.driver = driver;
		PageFactory.initElements(driver, this);
		extentTest = TestListener.getExtentTest();
		extentTest.log(Status.INFO, "Navigate to the Project Notes Page");
	}
	...
	public String getRecentNoteFromNotesTab() {
		extentTest.log(Status.INFO, "Get recent Note text from notes tab");
		return notesText.getText();

	}

	public String getRecentNoteTypeFromNotesTab() {
		extentTest.log(Status.INFO, "Get recent Note type from notes tab");
	...
	public NotesPage mouseoverNotesActionandClickDeleteNotes() {
		Actions action = new Actions(driver);
		action.moveToElement(notesActionDropdown).perform();
	...
	public void mouseoverNotesActionandClickViewNotes() {
		Actions action = new Actions(driver);
		action.moveToElement(notesActionDropdown).perform();
	...
	public Boolean isProjectOverViewSectionDisplayed() {
		...
		return projectOverviewSection.isDisplayed();
	}
	...
	public Boolean isimpProjectUpdatesSectionDisplayed() {
		...
		return impProjectUpdatesSection.isDisplayed();
	}
